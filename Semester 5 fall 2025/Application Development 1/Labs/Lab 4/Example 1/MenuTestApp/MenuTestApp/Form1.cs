...
namespace MenuTestApp
{
    public partial class MenuTestApplication : Form
    {
        ...
        {
            clearFontCheckMark();
            msgLabel.Font = new Font("Comic Sans MS", 14, msgLabel.Font.Style);
        ...
        {
            clearFontCheckMark();
            msgLabel.Font = new Font("Courier", 14, msgLabel.Font.Style);
        ...
        {
            clearFontCheckMark();
            msgLabel.Font = new Font("Times New Roman", 14, msgLabel.Font.Style);
